...
def get_loss_grad_funcs_classes(loss_func):
    ...
    def loss_func_z_batched(v, angles, shifts, ctf_params, imgs, z, sigma):
        return jax.vmap(loss_func_z, in_axes=(None, 0, 0, 0, 0, 0, None))(
            v, angles, shifts, ctf_params, imgs, z, sigma
        )

    @partial(jax.jit, static_argnums=(0,))
    def loss_func_z_sum(v, angles, shifts, ctf_params, imgs, z, sigma):
        return jnp.mean(
            loss_func_z_batched(v, angles, shifts, ctf_params, imgs, z, sigma)
        )
